...
const AQAR = () => {
  ...
  const renderAARTableRows = () => {
    const aarReports = AnnualQualityAssuranceReport.slice(3, 8); // Next three reports for AAR
  ...
  const renderAuditReportTableRows = () => {
    const auditReports = AnnualQualityAssuranceReport.slice(8); // Remaining reports for Audit Reports
